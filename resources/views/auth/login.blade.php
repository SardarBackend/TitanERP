...
<div style="background-color: black" id="main-wrapper" class="oxyy-login-register">
          ...
          <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
            <div class="hero-wrap rounded shadow-lg p-4 py-sm-5 px-sm-5 my-4">
              ...
              <div class="hero-content">
                <div class="logo mb-4"> <a class="d-flex justify-content-center" href="index.html" title="Oxyy"><img src="assets/images/1.png" alt="Oxyy"></a> </div>
                <form id="loginForm" class="form-dark" method="post">
                  <div class="form-group icon-group">
                    <input type="email" class="form-control" id="emailAddress" required placeholder="آدرس ایمیل">
                    <span class="icon-inside"><i class="fas fa-envelope"></i></span> </div>
                  <div class="form-group icon-group">
                    <input type="password" class="form-control" id="loginPassword" required placeholder="رمز عبور">
                  ...
                  <div class="row text-2 mt-4">
                    <div class="col-sm">
                      <div class="form-check custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label text-light" for="remember-me">به خاطر سپردن</label>
                      </div>
                    </div>
                    <div class="col-sm text-right"><a class="btn-link text-light" href="forgot-password.html">فراموشی رمز عبور؟</a></div>
                  </div>
                </form>
