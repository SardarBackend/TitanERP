<div class="user-profile-sidebar">
    ...
    <div class="p-3 border-bottom">
        <div class="user-profile-img">
            <img src="{{$chat_target->image}}" class="profile-img rounded" alt="">
            <div class="overlay-content rounded">
                ...
                <div class="mt-auto p-3">
                    <h5 class="user-name mb-0 text-truncate"> {{$chat_target->name}}</h5>
    ...
    <div class="p-4 user-profile-desc" data-simplebar>
        ...
        <div class="text-muted pt-4">
            <h5 class="fs-12 text-muted text-uppercase">بیوگرافی :</h5>
            <p class="mb-4">{{$chat_target->about}}
            </p>
        </div>

        <div class="pb-4 border-bottom border-bottom-dashed mb-4">
            <h5 class="fs-12 text-muted text-uppercase mb-2">اطلاعات :</h5>
            <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                    <i class="ri-user-line align-middle fs-15 text-muted"></i>
                </div>
                <div class="flex-grow-1 ms-3">
                    <h5 class="fs-14 text-truncate mb-0"> {{$chat_target->name}}</h5>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center mt-3">
                ...
                <div class="flex-grow-1 ms-3">
                    <h5 class="fs-14 text-truncate mb-0">{{$chat_target->email}}</h5>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center mt-3">
                ...
                <div class="flex-grow-1 ms-3">
                    <h5 class="fs-14 text-truncate mb-0">{{$chat_target->phone}}</h5>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center mt-3">
                ...
                <div class="flex-grow-1 ms-3">
                    <h5 class="fs-14 text-truncate mb-0">{{$chat_target->address}}</h5>
                </div>
            </div>
        </div>
