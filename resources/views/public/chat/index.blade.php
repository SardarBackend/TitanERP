                                    ...
                                    <div class="flex-grow-1 overflow-hidden">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3 ms-0">
                                                <img src="{{$chat_target->image}}" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                                <h6 class="text-truncate mb-0 fs-18"><a href="#"
                                                        class="user-profile-show text-reset">{{$chat_target->name}}</a></h6>
                            ...
                            <li class="chat-list left" id="1">
                                <div class="conversation-list">
                                    <div class="chat-avatar">
                                        <img src="{{$Message->User()->first()->image}}" alt="">
                                    </div>
                                ...
                                <div class="col">
                                    <div class="position-relative">
                                        ...
                                        <input  autocomplete="off" type="text"
                                            ...
                                            <input id="receiver_id" type="text" value="{{$chat_target->id}}" style="display: none" >
...
<script>
    ...
    // }
    const ONLILEDIV = document.getElementById("ONLILE")
    ...
    channel.bind('MessageSent', function (data) {
        ...
        if (data.sender_id != {{ auth()->id() }}) {
            avatarHtml = `<div class="chat-avatar">
                            <img src="/storage/${data.profile_image}" alt="کاربر">
                        </div>`;
        }
